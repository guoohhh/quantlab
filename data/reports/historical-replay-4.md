...
|---|---:|---:|---:|---:|---:|---:|---:|
| 纯策略 | 4 | 100.0% | 2.29% | 0.57% | 100.0% | 0.00% | ¥102,290.17 |
| 完整系统 | 0 | 0.0% | 0.00% | 0.00% | N/A | 0.00% | ¥100,000.00 |
| 沪深300同风险预算 | 4 | 100.0% | -2.04% | -0.51% | 0.0% | -2.04% | ¥97,955.12 |

## 单次回放

| 回合 | 信号日 | 标的 | Agent 动作 | 策略收益 | 完整系统收益 | 基准收益 | 闸门效果 | 实际方向 |
|---:|---|---|---|---:|---:|---:|---|---|
| 1 | 2024-01-02 | sh513100 | watch | 1.21% | 0.00% | -0.90% | missed_gain | up |
| 2 | 2024-08-21 | sh518880 | watch | 0.32% | 0.00% | -0.53% | missed_gain | up |
| 3 | 2025-05-20 | sh518880 | review_required | 0.22% | 0.00% | -0.39% | missed_gain | up |
| 4 | 2025-12-31 | sz159915 | watch | 0.53% | 0.00% | -0.24% | missed_gain | up |
...
```json
{
  "final_ensemble": {
    "samples": 4,
    "invalid_samples": 0,
    "brier_score": 0.10756914823297278,
    "log_loss": 0.6140527841934224,
    "accuracy": 1.0
  },
  "raw_llm": {
    "samples": 4,
    "invalid_samples": 0,
    "brier_score": 0.12298333333333333,
    "log_loss": 0.6731081975517835,
    "accuracy": 1.0
  },
  "point_in_time_statistical": {
    "samples": 3,
    "invalid_samples": 0,
    "brier_score": 0.08436078368734075,
    "log_loss": 0.517556956768809,
    "accuracy": 1.0
  }
}
```
